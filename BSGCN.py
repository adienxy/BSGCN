...
from models.SpectFormer import *
...
class BSGCNBertClassifier(nn.Module):
...
class GCNBert(nn.Module):
    def __init__(self, bert, opt, num_layers):
        ...
        self.spectformer = SpectralGatingNetwork(self.bert_dim)
        ...
        self.aggregate_W = nn.Linear(self.attdim*3, self.attdim)  
    ...
    def forward(self, inputs): 
        ...
        sequence_output = self.spectformer(sequence_output)
