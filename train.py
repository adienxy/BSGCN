...
from models.BSGCN import BSGCNBertClassifier
...
class Instructor:
    ...
    def __init__(self, opt):
        ...
        self.train_dataloader = DataLoader(dataset=trainset, batch_size=opt.batch_size, shuffle=True, num_workers=0)
...
def main():
    ...
    dataset_files = {
        ...
        'sst-5': {
            'train': './dataset/SST5_corenlp/train_write.json',
            'test': './dataset/SST5_corenlp/test_write.json',
        }
    }
    
    input_colses = {
        'bsgcn': ['text_bert_indices', 'bert_segments_ids', 'attention_mask', 'asp_start', 'asp_end', 'src_mask', 'aspect_mask','short_mask']
    }
    ...
    parser.add_argument('--model_name', type=str, help=', '.join(model_classes.keys()))
